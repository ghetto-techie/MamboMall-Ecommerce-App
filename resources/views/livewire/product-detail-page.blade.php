<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    {{-- Reviews Section --}}
    <section
        class="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6"
        wire:poll.10s
    >
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <article class="py-6">
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-3">
                            {{-- Avatar --}}
                            <div class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center font-semibold text-blue-700 dark:text-blue-300">
            ...
            @endforelse
                ...
                @auth
        <section class="mt-10 bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
            <div class="flex items-center gap-4 mb-6">
                {{-- Avatar --}}
                <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Reviewing as <span class="font-medium">{{ auth()->user()->name }}</span>
                    </p>
                </div>
            </div>
            ...
            <div
                x-data="{ show: false }"
                x-on:review-submitted.window="show = true; setTimeout(() => show = false, 5000)"
                x-show="show"
                x-transition
                class="mb-4 flex items-center gap-2 p-4 text-sm
